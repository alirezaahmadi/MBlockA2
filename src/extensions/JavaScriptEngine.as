package extensions
{
	...
	public class JavaScriptEngine
	{
		...
		public static var lastValue:String = "";
...
//			html += FileUtil.ReadString(File.applicationDirectory.resolvePath("js/AIRAliases.js"));
			...
			_htmlLoader.window.resumeThread = resumeThread;
			_htmlLoader.window.suspendThread = suspendThread;
		...
		public function responseValue(...args):void{
			if(args.length < 2){
		...
		public function get_lastVaue():String
		{	
			return lastValue;
		}
		...
		public function suspendThread(msg:String):void
		{
			RemoteCallMgr.Instance.suspendThread();
			//JOptionPane.showMessageDialog("", msg);
		}

		public function resumeThread(msg:String):void
		{
			RemoteCallMgr.Instance.resumeThread();
			//JOptionPane.showMessageDialog("", msg);
		}
