...
//				playerBG = new Shape(); // create, but don't add
			...
			SharedObjectManager.sharedManager().getObject("mblock-first-launch",false);
			...
			SharedObjectManager.sharedManager().getObject(versionString+".0."+_currentVer,false)
			...
			//setTimeout(ArduinoManager.sharedManager().clearTempFilesBL,1000);
			
			//setTimeout(SerialManager.sharedManager().disconnect,2000);
			
			//setTimeout(HIDManager.sharedManager().disconnect,2000);
			
			//setTimeout(ExtensionUtil.OnResetExtensions,1000);
			
			//MBlock.app.extensionManager.onSelectExtension("");
