...
package watchers {
	...
	import extensions.JavaScriptEngine;
...
public class Watcher extends Sprite implements DragClient {
	...
	public var currentVar:JavaScriptEngine = new JavaScriptEngine("mBot");
	public var ScrExt:ScratchExtension = new ScratchExtension("mBot",1);
	// stepping
...
//		var tem:String = ""; 
//		tem = JavaScriptEngine.lastValue;
//		if(tem!=null){
//		readout.setContents(formatValue(tem));
//		fixLayout();
//		}
//		else{
